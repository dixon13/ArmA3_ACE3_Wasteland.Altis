...
[
    ...
    ["M127A1 Hand Held Signal Flare (White)", "ACE_HandFlare_White", 25],
    ["M127A1 Hand Held Signal Flare (Red)", "ACE_HandFlare_Red", 25],
    ["M127A1 Hand Held Signal Flare (Green)", "ACE_HandFlare_Green", 25],
    ["M127A1 Hand Held Signal Flare (Yellow)", "ACE_HandFlare_Yellow", 25],
...
//Gun Store Ammo List
//Text name, classname, buy cost
//IR-DIM Rounds are Tracer Rounds that can only be seen with NVGs
//Creedmor (CM) 6.5mm rounds are similar to Lapua rounds
ammoArray = compileFinal str
[
    //9mm ammo
    ["9x21mm 16Rnd Mag", "16Rnd_9x21_Mag", 10],
	["9x21mm 30Rnd Mag", "30Rnd_9x21_Mag", 15],
    ["9x19mm 16Rnd Mag", "ACE_16Rnd_9x19_Mag", 10],
	["9x19mm 30Rnd Mag", "ACE_30Rnd_9x19_Mag", 15],
    //.45 ACP ammo
	...
	["5.56mm 30Rnd M995 AP Mag", "ACE_30Rnd_556x45_Stanag_M995_AP_mag", 50],
    ["5.56mm 30Rnd Mk262 HPBT Mag", "ACE_30Rnd_556x45_Stanag_Mk262_mag", 30],
    ["5.56mm 30Rnd Mk318 OTBT Mag", "ACE_30Rnd_556x45_Stanag_Mk318_mag", 25],
    ["5.56mm 30Rnd IR-DIM Mag", "ACE_30Rnd_556x45_Stanag_Trace_Dim", 35],
	...
	["6.5mm 30Rnd Tracer (Green) IR-DIM Mag", "ACE_30Rnd_65x39_caseless_green_mag_Tracer_Dim", 15],
    ["6.5mm 30Rnd Tracer (Red) IR-DIM Mag", "ACE_30Rnd_65x39_caseless_mag_Tracer_Dim", 15],
    //6.5mm Sniper Ammo MXM Only
    ["6.5x47mm Lapua (MXM) 30Rnd Mag", "ACE_30Rnd_65x47_Scenar_mag", 30],
    ["6.5mm CM (MXM) 30Rnd Mag", "ACE_30Rnd_65_Creedmor_mag", 30],
    //Done with MXM
	["6.5mm 100Rnd Belt Case", "100Rnd_65x39_caseless_mag", 75],
	["6.5mm 100Rnd IR-DIM (Red) Belt Case", "ACE_100Rnd_65x39_caseless_mag_Tracer_Dim", 50],
	["6.5mm 200Rnd IR-DIM Belt Case", "ACE_200Rnd_65x39_cased_Box_Tracer_Dim", 150],
	["6.5mm 200Rnd Tracer (Yellow) Belt Case", "200Rnd_65x39_cased_Box_Tracer", 125],
    //7.62x51mm ammo
	//["7.62x51mm 10Rnd Mag", "10Rnd_762x51_Mag", 15],
	 ["7.62x51mm 10Rnd M118LR Mag", "ACE_10Rnd_762x51_M118LR_Mag", 15],
	["7.62x51mm 10Rnd Mk316 Mod 0 Mag", "ACE_10Rnd_762x51_Mk316_Mod_0_Mag", 20],
    ["7.62x51mm 10Rnd Mk319 Mod 0 Mag", "ACE_10Rnd_762x51_Mk319_Mod_0_Mag", 25],
    ["7.62x51mm 10Rnd M993 AP Mag", "ACE_10Rnd_762x51_M993_AP_Mag", 35],
    ["7.62x51mm 20Rnd SD Mag", "ACE_20Rnd_762x51_Mag_SD", 30],
    ["7.62x51mm 20Rnd IR-DIM Mag", "ACE_20Rnd_762x51_Mag_Tracer_Dim", 35],
    ["7.62x51mm 20Rnd M118LR Mag", "ACE_20Rnd_762x51_M118LR_Mag", 35],
    ["7.62x51mm 20Rnd Mk316 Mod 0 Mag", "ACE_20Rnd_762x51_Mk316_Mod_0_Mag", 40],
    ["7.62x51mm 20Rnd Mk319 Mod 0 Mag", "ACE_20Rnd_762x51_Mk319_Mod_0_Mag", 45],
    ["7.62x51mm 20Rnd M993 AP Mag", "ACE_20Rnd_762x51_M993_AP_Mag", 50],
    //["7.62x51mm 150Rnd Box", "150Rnd_762x51_Box", 150],
	//["7.62x51mm 150Rnd Tracer (Green) Box", "150Rnd_762x51_Box_Tracer", 125],
    //7.62x54mm ammo
    ["7.62x54mm 10Rnd Tracer Mag", "ACE_10Rnd_762x54_Trace_mag", 15],
    ...
    //7.62x67mm MK248 Ammo
    ["7.62x67mm 20Rnd Mk248 Mod 0 (Noreen) Mag", "ACE_20Rnd_762x67_Mk248_Mod_0_Mag", 40],
    ["7.62x67mm 20Rnd Mk248 Mod 1 (Noreen) Mag", "ACE_20Rnd_762x67_Mk248_Mod_1_Mag", 45],
    ["7.62x67mm 20Rnd Berger Hybrid OTM (Noreen) Mag", "ACE_20Rnd_762x67_Berger_Hybrid_OTM_Mag", 55],
    //.338 ammo
	[".338 LM 10Rnd Mag", "10Rnd_338_Mag", 50],
	[".338 NM 130Rnd Belt", "130Rnd_338_Mag", 150],
    [".338 10Rnd 300gr HPBT Mag", "ACE_10Rnd_338_300gr_HPBT_Mag", 55],
    [".338 10Rnd API Mag", "ACE_10Rnd_338_API526_Mag", 60],
    //9.3mm ammo
    ...
    //12.7mm ammo
	["12.7mm 5Rnd Mag", "ACE_5Rnd_127x99_Mag", 50],
	["12.7mm 5Rnd Armor-Piercing Mag", "5Rnd_127x108_APDS_Mag", 60],
    ["12.7mm 5Rnd API Mag", "ACE_5Rnd_127x99_API_Mag", 60],
    ["12.7mm 5Rnd AMAX Mag", "ACE_5Rnd_127x99_AMAX_Mag", 55],
...
[
    ...
    ["IR Laser Pointer w/Green", "ACE_acc_pointer_green_IR", 30, "item"],
	...
	["MRCO (PIP)", "ACE_optic_MRCO_PIP", 100, "item"],
	["ARCO (2D)", "ACE_optic_Arco_2D", 125, "item"],
    ["ARCO (PIP)", "ACE_optic_Arco_PIP", 125, "item"],
	["RCO (2D)", "ACE_optic_Hamr_2D", 150, "item"],
    ["RCO (PIP)", "ACE_optic_Hamr_PIP", 150, "item"],
	["MOS (2D)", "ACE_optic_SOS_2D", 150, "item"],
    ["MOS (PIP)", "ACE_optic_SOS_PIP", 150, "item"],
    ...
    ["LRPS (PIP)", "ACE_optic_LRPS_PIP", 300, "item"],
...
<<<<<<< HEAD
    ...
    ["Field Dressing", "ACE_fieldDressing", 5, "item"],
    ["Elastic Bandage", "ACE_elasticBandage", 5, "item"],
    //["Packing Bandage (large wounds)", "ACE_packingBandage", 5, "item"], Advanced Medical Only
    ["Tourniquet", "ACE_tourniquet", 5, "item"],
    //["Personal Aid Kit (PAK)", "ACE_personalAidKit", 10, "item"], Advanced Medical Only
    ["Ear Plugs", "ACE_EarPlugs", 5, "item"],
    ["Morphine autoinjector", "ACE_morphine",20, "item"],
    ["Epinephrine autoinjector", "ACE_epinephrine",20, "item"],
    ["Atropine autoinjector","ACE_atropine", 20, "item"],
    ["Saline IV, 1000ml", "ACE_salineIV", 24, "item"],
    ["Saline IV, 500ml", "ACE_salineIV_500", 12, "item"],
    ["Saline IV, 250ml", "ACE_salineIV_250", 6, "item"],
    ["Blood IV 1000ml", "ACE_bloodIV", 50, "item"],
    ["Blood IV 500ml", "ACE_bloodIV_500", 25, "item"],
    ["Blood IV 250ml", "ACE_bloodIV_250", 10, "item"],
    //["Plasma IV 1000ml", "ACE_plasmaIV", 50, "item"],
    //["Plasma IV 500ml", "ACE_plasmaIV_500", 25, "item"],
    //["Plasma IV 250ml", "ACE_plasmaIV_250", 10, "item"],
...
>>>>>>> eb0ec3ac7f467913d17310c4b8c44b1f8c03a040
    ...
    ["NV Goggles (GEN3)", "ACE_NVG_Gen3", 200, "nvg"],
    ["NV Goggles (GEN4)", "ACE_NVG_Gen4", 250, "nvg"],
    ["NV Goggles (Wide)", "ACE_NVG_Wide", 300, "nvg"],
    ["Diving Goggles", "G_Diving", 100, "gogg"],
	["Binoculars", "Binocular", 50, "binoc"],
    ["Vector Rangefinder", "ACE_Vector", 150, "binoc"],
	["Rangefinder", "Rangefinder", 150, "binoc"],
    ["Atragmx", "ACE_ATragMX", 50, "item"],
    ["M57 Firing Device (Explosives Clacker)", "ACE_Clacker", 25, "item"],
    ["M26 Firing Device (Explosives Clacker)", "ACE_M26_Clacker", 25, "item"],
    ["Defusal Kit", "ACE_DefusalKit", 50, "item"],
    ["Dead Man's Switch (Suicide switch)", "ACE_DeadManSwitch", 100, "item"],
    ["Cellphone (Remote detonator)", "ACE_Cellphone", 50, "item"],
    ["Altimete Watch", "ACE_Altimeter", 25, "item"],
    ["Rifle Range Card", "ACE_RangeCard", 25, "item"],
    ...
    ["Spare Barrel (for LMGs and SAWs)", "ACE_SpareBarrel", 100, "item"],
